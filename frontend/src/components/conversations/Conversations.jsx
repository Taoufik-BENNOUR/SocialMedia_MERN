...
const Conversations = ({conversation,currentUser}) => {
  ...
  const [friendId, setfriendId] = useState(conversation.members.find((m)=>m !== currentUser ))
  useEffect(() => {
      const getUser = async ()=>{
        try {
